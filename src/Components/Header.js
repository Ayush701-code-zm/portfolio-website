...
function Header() {
  ...
  <img className="w-14 mr-4" src={logos.logogradient} alt="logo" /> {/* Adjusted margin */}
  {/* <span className="text-xl font-bold">Your Name Here</span> Name added beside the logo */}
</NavLink>
